namespace RMD.Models.Pacientes
{
    public class PacienteConsultaRequest
    {
        ...
        // Listas adicionales
        public List<AllergyModel> Alergias { get; set; } = new List<AllergyModel>(); // T2.Alergias
        public List<MoleculeModel> Molecules { get; set; } = new List<MoleculeModel>(); // T2.Molecules
        public List<CIM10Model> Patologias { get; set; } = new List<CIM10Model>(); // T2.Patologias
    }
}
