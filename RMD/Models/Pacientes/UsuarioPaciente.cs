namespace RMD.Models.Pacientes
{
    public class UsuarioPaciente
    {
        ...
        public Guid? IdGEMP { get; set; } // Puede ser nullable
        public Guid? IdSucursal { get; set; } // Puede ser nullable
        public string Nombres { get; set; } = string.Empty;
        public string PrimerApellido { get; set; } = string.Empty;
        public string SegundoApellido { get; set; } = string.Empty;
        public string FechaNacimiento { get; set; }
        public int? IdEntidadNacimiento { get; set; } // Puede ser nullable
