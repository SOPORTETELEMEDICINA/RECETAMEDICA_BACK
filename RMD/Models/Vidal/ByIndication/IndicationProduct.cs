...
//{
//    public class IndicationProduct
//    {
//        public string Title { get; set; } = string.Empty;
//        public string AlternateLink { get; set; } = string.Empty;
//        public string PackagesLink { get; set; } = string.Empty;
//        public string MoleculesLink { get; set; } = string.Empty;
//        public string ActiveExcipientsLink { get; set; } = string.Empty;
//        public string RecosLink { get; set; } = string.Empty;
//        public string ForeignProductsLink { get; set; } = string.Empty;
//        public string IndicationsLink { get; set; } = string.Empty;
//        public string ContraindicationsLink { get; set; } = string.Empty;
//        public string RestrictedPrescriptionsLink { get; set; } = string.Empty;
//        public string PdsLink { get; set; } = string.Empty;
//        public string UcdsLink { get; set; } = string.Empty;
//        public string UnitsLink { get; set; } = string.Empty;
//        public string FoodInteractionsLink { get; set; } = string.Empty;
