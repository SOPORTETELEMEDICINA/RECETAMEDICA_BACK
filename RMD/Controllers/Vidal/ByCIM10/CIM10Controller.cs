...
namespace RMD.Controllers.Vidal.ByCIM10
{
    [ApiController]
    [Authorize]
    ...
    public class CIM10Controller(ICIM10Service cim10Service) : ControllerBase
    {
        private readonly ICIM10Service _cim10Service = cim10Service;
