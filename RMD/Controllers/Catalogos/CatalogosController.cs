...
//    public class CatalogosController(ICatalogosService catalogoService) : ControllerBase
//    {
//        private readonly ICatalogosService _catalogoService = catalogoService;
...
//            {
//                return Ok(ResponseFromService<IEnumerable<CatalogoRequest>>.Success(new List<CatalogoRequest>(), "No se encontraron resultados."));
//            }

//            return Ok(ResponseFromService<IEnumerable<CatalogoRequest>>.Success(result));
//        }
...
//        [Authorize]
//        [ServiceFilter(typeof(ValidateTokenFilter))]
//        public async Task<IActionResult> CreateOrUpdateCatalogo([FromBody] CatalogoRequest catalogo)
//        {
//            if (catalogo == null)
//            {
