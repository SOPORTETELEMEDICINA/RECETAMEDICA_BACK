...
//                        QuantityUnit = entry.Element(ns + "quantityUnit")?.Value ?? string.Empty,
...
//                        // Extraemos los links
//                        RoutesLink = entry.Elements(atom + "link").Where(l => (string)l.Attribute("title") == "ROUTES")
//                                        .Select(l => (string)l.Attribute("href")).FirstOrDefault(),
//                        UnitsLink = entry.Elements(atom + "link").Where(l => (string)l.Attribute("title") == "UNITS")
//                                        .Select(l => (string)l.Attribute("href")).FirstOrDefault(),
//                        MoleculesLink = entry.Elements(atom + "link").Where(l => (string)l.Attribute("title") == "MOLECULES")
//                                        .Select(l => (string)l.Attribute("href")).FirstOrDefault(),
//                        PackagesLink = entry.Elements(atom + "link").Where(l => (string)l.Attribute("title") == "PACKAGES")
//                                        .Select(l => (string)l.Attribute("href")).FirstOrDefault(),
//                        ProductsLink = entry.Elements(atom + "link").Where(l => (string)l.Attribute("title") == "PRODUCTS")
//                                        .Select(l => (string)l.Attribute("href")).FirstOrDefault(),
//                        PrescribablesLink = entry.Elements(atom + "link").Where(l => (string)l.Attribute("title") == "PRESCRIBABLES")
//                                            .Select(l => (string)l.Attribute("href")).FirstOrDefault(),
//                        VmpLink = entry.Elements(atom + "link").Where(l => (string)l.Attribute("title") == "VMP")
//                                    .Select(l => (string)l.Attribute("href")).FirstOrDefault()
//                    };
...
//                    VmpId = int.TryParse(entry.Element(ns + "vmp")?.Attribute("vidalId")?.Value, out var vmpId) ? vmpId : (int?)null,

//                    // Extraer los links relacionados
//                    UnitsLink = entry.Elements(atom + "link").FirstOrDefault(l => (string)l.Attribute("title") == "UNITS")?.Attribute("href")?.Value ?? string.Empty,
//                    RoutesLink = entry.Elements(atom + "link").FirstOrDefault(l => (string)l.Attribute("title") == "ROUTES")?.Attribute("href")?.Value ?? string.Empty,
//                    IndicatorsLink = entry.Elements(atom + "link").FirstOrDefault(l => (string)l.Attribute("title") == "INDICATORS")?.Attribute("href")?.Value ?? string.Empty,
//                    PackagesLink = entry.Elements(atom + "link").FirstOrDefault(l => (string)l.Attribute("title") == "PACKAGES")?.Attribute("href")?.Value ?? string.Empty,
//                    ProductsLink = entry.Elements(atom + "link").FirstOrDefault(l => (string)l.Attribute("title") == "PRODUCTS")?.Attribute("href")?.Value ?? string.Empty,
//                    SideEffectsLink = entry.Elements(atom + "link").FirstOrDefault(l => (string)l.Attribute("title") == "SIDE_EFFECTS")?.Attribute("href")?.Value ?? string.Empty,
//                    PrescribablesLink = entry.Elements(atom + "link").FirstOrDefault(l => (string)l.Attribute("title") == "PRESCRIBABLES")?.Attribute("href")?.Value ?? string.Empty,
//                    AtcClassificationLink = entry.Elements(atom + "link").FirstOrDefault(l => (string)l.Attribute("title") == "ATC_CLASSIFICATION")?.Attribute("href")?.Value ?? string.Empty,
//                    ProductLink = entry.Elements(atom + "link").FirstOrDefault(l => (string)l.Attribute("title") == "PRODUCT")?.Attribute("href")?.Value ?? string.Empty,
//                    MoleculesLink = entry.Elements(atom + "link").FirstOrDefault(l => (string)l.Attribute("title") == "MOLECULES")?.Attribute("href")?.Value ?? string.Empty,
//                    ActiveExcipientsLink = entry.Elements(atom + "link").FirstOrDefault(l => (string)l.Attribute("title") == "ACTIVE_EXCIPIENTS")?.Attribute("href")?.Value ?? string.Empty,
//                    VmpLink = entry.Elements(atom + "link").FirstOrDefault(l => (string)l.Attribute("title") == "VMP")?.Attribute("href")?.Value ?? string.Empty
//                }).ToList();
//            }
//            catch (Exception ex)
//            {
