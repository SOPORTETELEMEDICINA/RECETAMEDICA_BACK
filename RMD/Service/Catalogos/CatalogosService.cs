...
//        public CatalogosService(ApplicationDbContext context)
//        {
//            _context = context;
//        }

//        public async Task<IEnumerable<CatalogoRequest>> GetCatalogoByIdCP(int idCP)
//        {
//            try
//            {
...
//        public async Task<IEnumerable<CatalogoRequest>> GetCatalogoByIdMunicipio(int idMunicipio)
//        {
//            var results = await _context.Catalogos
...
//        public async Task<IEnumerable<CatalogoRequest>> GetCatalogoByIdAsentamiento(int idAsentamiento)
//        {
//            var results = await _context.Catalogos
...
//        public async Task<IEnumerable<CatalogoRequest>> GetCatalogoByIdCiudad(int idCiudad)
//        {
//            var results = await _context.Catalogos
...
//        public async Task<string> CreateOrUpdateCatalogo(CatalogoRequest catalogo)
//        {
//            var parameter = new SqlParameter("@CatalogoData", SqlDbType.Structured)
//            {
//                TypeName = "dbo.CatalogoType",
//                Value = new List<CatalogoRequest> { catalogo }.ToDataTable()
//            };
