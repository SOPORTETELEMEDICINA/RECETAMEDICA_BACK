...
//            try
//            {
//                var parsed = JsonSerializer.Deserialize<ResponseFromService<string>>(json, new JsonSerializerOptions
//                {
...
//                {
//                    if (EsTextoCifradoPosible(parsed.Data))
//                    {
//                        parsed.Data = DecryptionHelper.DecryptData(parsed.Data, _key);
...
//                    }
//                    // Si no es texto cifrado, lo dejamos tal como está
//                }
//            }
//            catch
//            {
...
//            // Si empieza con XML o HTML tags, asumimos que NO está cifrado
//            if (texto.StartsWith("<") || texto.StartsWith("&lt;"))
//                return false;

//            // Si tiene llaves, asumimos que es un JSON ya plano
//            if (texto.StartsWith("{") || texto.StartsWith("["))
//                return false;

//            // Si tiene menos de 16 caracteres, probablemente no es un texto cifrado
//            if (texto.Length < 16)
//                return false;

//            // Si contiene tags html o xml, tampoco desencriptamos
//            if (texto.Contains("<html") || texto.Contains("<div") || texto.Contains("<?xml") || texto.Contains("DOCTYPE"))
//                return false;

//            // Caso contrario, asumimos que sí está cifrado
//            return true;
//        }
//    }
//}
