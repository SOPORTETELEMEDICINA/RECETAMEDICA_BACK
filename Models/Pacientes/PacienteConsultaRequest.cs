...
namespace RMD.Models.Pacientes
{
    public class PacienteConsultaRequest
    {
        ...
        // Listas adicionales
        public List<RequestSearchAllergy> Alergias { get; set; } = new List<RequestSearchAllergy>(); // T2.Alergias
        public List<RequestSearchMolecules> Molecules { get; set; } = new List<RequestSearchMolecules>(); // T2.Molecules
        public List<RequestSearchCIM10> Patologias { get; set; } = new List<RequestSearchCIM10>(); // T2.Patologias
    }
}
